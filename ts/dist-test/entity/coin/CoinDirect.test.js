...
(0, node_test_1.describe)('CoinDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CoinpaprikaSDK({
    ...
    (0, node_test_1.test)('direct-list-coin', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-coin', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CoinpaprikaSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['COINPAPRIKA_TEST_COIN_ENTID'];
    ...
    const client = new __1.CoinpaprikaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CoinDirect.test.js.map
...
function envOverride(m) {
    if ('TRUE' === process.env.COINPAPRIKA_TEST_LIVE ||
        'TRUE' === process.env.COINPAPRIKA_TEST_OVERRIDE) {
    ...
    m.COINPAPRIKA_TEST_EXPLAIN = process.env.COINPAPRIKA_TEST_EXPLAIN || m.COINPAPRIKA_TEST_EXPLAIN;
    return m;
}

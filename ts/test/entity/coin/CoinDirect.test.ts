...
describe('CoinDirect', async () => {
  ...
  test('direct-list-coin', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-coin', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['COINPAPRIKA_TEST_COIN_ENTID']

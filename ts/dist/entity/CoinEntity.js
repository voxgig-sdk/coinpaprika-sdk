...
class CoinEntity extends CoinpaprikaEntityBase_1.CoinpaprikaEntityBase {
    ...
    make() {
        return new CoinEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Coin[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=CoinEntity.js.map
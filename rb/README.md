...
The Ruby SDK for the Coinpaprika API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `CoinpaprikaError` (a `StandardError` subclass), so wrap

...
#      offline in seeded test mode (CoinpaprikaSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Coinpaprika_sdk.rb")
  SDK_CLASS = "CoinpaprikaSDK"

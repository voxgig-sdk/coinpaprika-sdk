...
module CoinpaprikaTestRunner
  ...
  def self.env_override(m)
    live = getenv("COINPAPRIKA_TEST_LIVE")
    override = getenv("COINPAPRIKA_TEST_OVERRIDE")
    ...
    explain = getenv("COINPAPRIKA_TEST_EXPLAIN")
    m["COINPAPRIKA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CoinpaprikaTestRunner
Helpers = CoinpaprikaHelpers
Vs = VoxgigStruct

...
// Coinpaprika SDK utility: fetcher
...
class CoinpaprikaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CoinpaprikaSDK/1.0)';
    ...
    public static function call(CoinpaprikaContext $ctx, string $fullurl, array $fetchdef): array
    {

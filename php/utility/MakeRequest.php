...
// Coinpaprika SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CoinpaprikaMakeRequest
{
    public static function call(CoinpaprikaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CoinpaprikaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CoinpaprikaResponse($fetched);
        } else {

...
// Coinpaprika SDK utility: graphql
//
...
class CoinpaprikaGraphql
{
    ...
    // equivalent.
    public static function body(CoinpaprikaContext $ctx): mixed
    {
    ...
    public static function errors(CoinpaprikaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

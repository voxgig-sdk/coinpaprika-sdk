...
class CoinpaprikaTestRunner
{
    ...
    {
        $live = self::getenv('COINPAPRIKA_TEST_LIVE');
        $override = self::getenv('COINPAPRIKA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('COINPAPRIKA_TEST_EXPLAIN');
...
class_alias('CoinpaprikaTestRunner', 'Runner');
class_alias('CoinpaprikaHelpers', 'Helpers');

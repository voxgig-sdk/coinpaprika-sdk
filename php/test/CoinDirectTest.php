...
class CoinDirectTest extends TestCase
{
    public function test_direct_list_coin(): void
    {
        $setup = coin_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-coin", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

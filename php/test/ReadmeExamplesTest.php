...
// Coinpaprika SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CoinpaprikaSDK::test)
...
{
    private const SDK_CLASS = 'CoinpaprikaSDK';
    ...
    private const SDK_BASE = 'coinpaprika_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../coinpaprika_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

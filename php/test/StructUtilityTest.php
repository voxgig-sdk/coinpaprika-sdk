...
// Coinpaprika SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CoinpaprikaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CoinpaprikaOmni::structfix($now, Struct::undef()))
                        !== json_encode(CoinpaprikaOmni::structfix($val, Struct::undef()))) {

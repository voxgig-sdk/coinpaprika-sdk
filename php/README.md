...
The PHP SDK for the Coinpaprika API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Coin(null)->list(null, null);
...
[$result, $err] = $client->Coinpaprika(null)->load(
    ["id" => "test01"], null
);

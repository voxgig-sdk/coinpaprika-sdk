...
The PHP SDK for the Coinpaprika API — an entity-oriented client using PHP conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `$client->Coin()` — with named operations (`list`) instead of raw URL paths and query strings. Working with resources and verbs keeps call sites self-describing and reduces cognitive load.
...
```
php/
├── coinpaprika_sdk.php          -- Main SDK class
...
The main class (`coinpaprika_sdk.php`) exports the SDK class

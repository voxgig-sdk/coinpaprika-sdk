...
// Coinpaprika SDK timeout feature
...
class CoinpaprikaTimeoutFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _with_timeout(CoinpaprikaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CoinpaprikaContext $_ctx, float $ms): void
    {
        $client = $this->client;

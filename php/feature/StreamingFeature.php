...
// Coinpaprika SDK streaming feature
...
class CoinpaprikaStreamingFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _iterate(CoinpaprikaResult $result): \Generator
    {
    ...
    private function _streamable(CoinpaprikaContext $ctx): bool
    {

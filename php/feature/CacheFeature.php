...
class CoinpaprikaCacheFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _through(CoinpaprikaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

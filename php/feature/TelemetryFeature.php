...
// Coinpaprika SDK telemetry feature
...
class CoinpaprikaTelemetryFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _close(CoinpaprikaContext $ctx, bool $ok): void
    {

...
// Coinpaprika SDK idempotency feature
...
class CoinpaprikaIdempotencyFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _mutating(CoinpaprikaContext $ctx): bool
    {

...
class CoinpaprikaProxyFeature extends CoinpaprikaBaseFeature
{
    ...
    public function init(CoinpaprikaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CoinpaprikaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

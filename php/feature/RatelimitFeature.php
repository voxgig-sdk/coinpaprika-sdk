...
// Coinpaprika SDK ratelimit feature
...
class CoinpaprikaRatelimitFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _acquire(CoinpaprikaContext $ctx): void
    {
    ...
    private function _track(CoinpaprikaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

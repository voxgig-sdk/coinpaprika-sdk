...
func registerSDKWords(r *eng.Registry, client *sdk.CoinpaprikaSDK) {
...
func runOp(client *sdk.CoinpaprikaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

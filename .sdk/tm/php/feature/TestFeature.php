...
// Coinpaprika SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CoinpaprikaTestFeature extends CoinpaprikaBaseFeature
{
    ...
    public function init(CoinpaprikaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CoinpaprikaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CoinpaprikaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CoinpaprikaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CoinpaprikaContext $ctx, $op, $args): array
    {

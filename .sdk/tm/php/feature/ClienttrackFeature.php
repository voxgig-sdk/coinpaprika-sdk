...
// Coinpaprika SDK clienttrack feature
...
class CoinpaprikaClienttrackFeature extends CoinpaprikaBaseFeature
{
    ...
    public function PostConstruct(CoinpaprikaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Coinpaprika-SDK';

...
// Coinpaprika SDK metrics feature
...
class CoinpaprikaMetricsFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _record(CoinpaprikaContext $ctx, bool $ok): void
    {

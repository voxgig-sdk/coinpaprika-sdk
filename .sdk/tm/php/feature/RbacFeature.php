...
class CoinpaprikaRbacFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _required(CoinpaprikaContext $ctx): ?string
    {
    ...
    private function _reject(CoinpaprikaContext $ctx, string $required): void
    {
    ...
    private function _track(CoinpaprikaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

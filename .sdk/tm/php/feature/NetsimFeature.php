...
// Coinpaprika SDK netsim feature
...
class CoinpaprikaNetsimFeature extends CoinpaprikaBaseFeature
{
    ...
    private function _simulate(CoinpaprikaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CoinpaprikaContext $ctx, array $applied): void
    {
        $client = $this->client;

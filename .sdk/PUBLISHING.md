...
|---|---|---|
| `ts/` | @voxgig-sdk/coinpaprika-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/coinpaprika-sdk \
      --repository voxgig-sdk/coinpaprika-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/coinpaprika-sdk` shows it, and
`npm trust revoke @voxgig-sdk/coinpaprika-sdk --id=<id>` removes it.

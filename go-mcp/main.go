// Command Coinpaprika-mcp is an MCP server exposing the Coinpaprika
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Coinpaprika_list  — list records of an entity
//	Coinpaprika_load  — load a single record of an entity
//

...
const testSeed = `map[string]any{"entity": map[string]any{"coin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticker": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

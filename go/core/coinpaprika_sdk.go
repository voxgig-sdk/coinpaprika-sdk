...
func (sdk *CoinpaprikaSDK) OptionsMap() map[string]any {
...
func (sdk *CoinpaprikaSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CoinpaprikaSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CoinpaprikaSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CoinpaprikaSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CoinpaprikaSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CoinpaprikaSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CoinpaprikaSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CoinpaprikaSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CoinpaprikaSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CoinpaprikaSDK: graphql: %s", msg)
		res["graphql"] = errors
	}

...
func NewCoinEntity(client *core.CoinpaprikaSDK, entopts map[string]any) *CoinEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CoinEntity) GetName() string { return e.name }
...
func (e *CoinEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CoinEntity) Deleted() bool {
	return e.deleted
}


func (e *CoinEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCoinEntity(e.client, opts)
}

func (e *CoinEntity) Data(args ...any) any {
...
func (e *CoinEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Coin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CoinEntity) DataTyped(data ...Coin) Coin {
	if len(data) > 0 {
		return typedFrom[Coin](e.Data(asMap(data[0])))
	}
	return typedFrom[Coin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Coin (all fields
// optional at the wire level).
func (e *CoinEntity) MatchTyped(match ...Coin) Coin {
	if len(match) > 0 {
		return typedFrom[Coin](e.Match(asMap(match[0])))
	}
	return typedFrom[Coin](e.Match())
}
...
func (e *CoinEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CoinEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CoinEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CoinListMatch and returns []Coin. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CoinEntity) ListTyped(reqmatch CoinListMatch, ctrl map[string]any) ([]Coin, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Coin](res), nil
}



func (e *CoinEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CoinEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CoinEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CoinEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

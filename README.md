...
This is an unofficial SDK for the Coinpaprika public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/coinpaprika` | `npm install @voxgig-sdk/coinpaprika` |
| Python | `voxgig-sdk-coinpaprika` | `pip install voxgig-sdk-coinpaprika` |
| PHP | `voxgig-sdk/coinpaprika` | `composer require voxgig-sdk/coinpaprika` |
| Golang | `github.com/voxgig-sdk/coinpaprika-sdk/go` | `go get github.com/voxgig-sdk/coinpaprika-sdk/go` |
| Ruby | `voxgig-sdk-coinpaprika` | `gem install voxgig-sdk-coinpaprika` |
| Lua | `voxgig-sdk-coinpaprika` | `luarocks install voxgig-sdk-coinpaprika` |

...
The Python SDK for the Coinpaprika API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Coin()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/coinpaprika-sdk/releases)) or
...
| --- | --- | --- |
| `id` | `str` | Unique identifier for the coin |
...
| `type` | `str` | Type of cryptocurrency (coin or token) |
...
| `first_data_at` | `str` | Date of first data availability |
| `id` | `str` | Unique identifier for the coin |
| `last_updated` | `str` | Last update timestamp |
| `max_supply` | `float` | Maximum supply of the coin |
| `name` | `str` | Name of the cryptocurrency |
| `quotes` | `dict` | Price and market data in different quote currencies |
| `rank` | `int` | Market cap rank |
| `symbol` | `str` | Ticker symbol of the cryptocurrency |
...
```
py/
├── coinpaprika_sdk.py         -- Main SDK module

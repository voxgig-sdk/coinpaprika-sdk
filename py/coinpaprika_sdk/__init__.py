...
from coinpaprika_sdk.utility import register

# Load features
from coinpaprika_sdk.feature.base_feature import CoinpaprikaBaseFeature
from coinpaprika_sdk.features import _has_feature, _make_feature
...
class CoinpaprikaSDK:
    ...
    def get_utility(self):
        return CoinpaprikaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CoinpaprikaSDK: graphql: " + str(msg))
            res["graphql"] = errors

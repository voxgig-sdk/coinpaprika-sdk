# Coinpaprika SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CoinpaprikaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CoinpaprikaSDK(...) and CoinpaprikaSDK.test(...) become
#      CoinpaprikaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "coinpaprika_sdk"
_SDK_CLASS = "CoinpaprikaSDK"

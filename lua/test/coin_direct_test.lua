...
describe("CoinDirect", function()
  it("should direct-list-coin", function()
    local setup = coin_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-coin", setup.live and "live" or "unit")
...
function coin_direct_setup(mockres)

...
function runner.env_override(m)
  local live = runner.getenv("COINPAPRIKA_TEST_LIVE")
  local override = runner.getenv("COINPAPRIKA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COINPAPRIKA_TEST_EXPLAIN")
